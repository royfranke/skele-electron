...
contextBridge.exposeInMainWorld(
  "api", {
      invoke: (channel, data) => {
      let validChannels = ["save-data","save-settings","load-chunk","save-chunk","load-portal-index","save-portal-index"]; // list of ipcMain.handle channels you want access in frontend to
