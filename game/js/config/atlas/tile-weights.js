...
const TILE_WEIGHTS = {
  ...
  TILE: {
      ...
      {
        index: [1270, 1271, 1272, 1273, 1274, 1275, 1276, 1277, 1278],
        weight: 1
      }
    ],
    CHECKERED_WHITE_BROWN_: [
      {
        index: [1279, 1280, 1281, 1282, 1283, 1284, 1285, 1286, 1287],
        weight: 1
      }
    ],
    CHECKERED_GREEN_BLUE_PURPLE_BLACK_: [
      {
        index: [1288, 1289, 1290, 1291, 1292, 1293, 1294, 1295, 1296],
        weight: 1
      }
    ],
    GREEN_CHECKERED_: [
      {
        index: [1297, 1298, 1299, 1300, 1301, 1302, 1303, 1304, 1305],
        weight: 1
      }
    ],
},
